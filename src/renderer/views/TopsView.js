...
import { attachTopsViewAudio, initTopsViewAudioState } from "./TopsViewAudio.js";
import { attachTopsViewAudioPanel } from "./TopsViewAudioPanel.js";
import { attachTopsViewMail } from "./TopsViewMail.js";
import { attachTopsViewPrint } from "./TopsViewPrint.js";
import { attachTopsViewMeetingWorkflow } from "./TopsViewMeetingWorkflow.js";
...
_isoToDDMMYYYY(iso) {
  ...
  // Audio methods attached via TopsViewAudio.js
  ...
  render() {
    ...
    btnEndMeeting.onclick = async () => {
      if (this._busy) return;
      await this._handleClickEndMeeting();
    };
...
attachTopsViewAudioPanel(TopsView);
attachTopsViewAudio(TopsView);
attachTopsViewMail(TopsView);
attachTopsViewPrint(TopsView);
attachTopsViewMeetingWorkflow(TopsView);
